          ...
          <div className="flex flex-wrap justify-between items-center">
            <div className="w-full md:w-1/2 mb-6 md:mb-0">
              ...
              <div className="flex space-x-5">
                <a href="#" className="text-gray-700 hover:text-primary social-icon">
            ...
            <div className="w-full md:w-1/2">
              <div className="flex items-center justify-end space-x-3">
                <Link href="/terms" className="text-base font-medium text-gray-700 hover:text-primary footer-link">
                  Terms
                </Link>
                <span className="text-gray-500">•</span>
                <Link href="/privacy" className="text-base font-medium text-gray-700 hover:text-primary footer-link">
                  Privacy
                </Link>
                <span className="text-gray-500">•</span>
                <Link href="/about" className="text-base font-medium text-gray-700 hover:text-primary footer-link">
                  About
                </Link>
                <span className="text-gray-500">•</span>
